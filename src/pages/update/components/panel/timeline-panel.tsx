// update/components/panel/timeline-panel.tsx
...
const PIXELS_PER_SECOND_DEFAULT = 50; // MP3 mode: 50px per second
const PIXELS_PER_TICK_DEFAULT = 0.1; // MIDI mode: 0.1px per tick
